...
1. [[Link Rewrite|Module:-Link-Rewrite]]
1. [[Link Rewrite (HTTPS)|Module:-Link-Rewrite-(HTTPS)]]
1. [[Link Rewrite (TEL)|Module:-Link-Rewrite-(TEL)]]
1. [[Link Rewrite (Clicked Event)|Module:-Link-Rewrite-(Clicked-Event)]]
