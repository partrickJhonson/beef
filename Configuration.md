...
To configure extensions, the [`config.yaml`](https://github.com/beefproject/beef/blob/master/config.yaml) files will be found in the extension folder that you're trying to modify.
